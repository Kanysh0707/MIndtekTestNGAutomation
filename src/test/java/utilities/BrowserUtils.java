...
public class BrowserUtils {
    /*
    Method that will accept dropdown WebElement and of
    that dropdown, and it will select that value which is provided in parameter
    Ex:
    .selectByValue(dropdownElemennt,"1");->void
